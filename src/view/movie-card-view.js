...
const createMovieCardExtraTopRatedViewTemplate = () =>(
...
class MovieCardExtraTopRatedView {
  getTemplate() {
...
const createMovieCardExtraMostCommentedViewTemplate = () =>(
  `<section class="films-list films-list--extra">
...
class MovieCardExtraMostCommentedView {
  getTemplate() {
    return createMovieCardExtraMostCommentedViewTemplate();
  }
...
export{MovieCardListView, FilmsListView, MovieCardContainerView, MovieCardView, MovieCardExtraTopRatedView, MovieCardExtraMostCommentedView};
