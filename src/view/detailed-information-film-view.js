...
const createFilmDetailsTopContainerViewTemplate = () => (
...
class FilmDetailsTopContainerView {
  getTemplate() {
    return createFilmDetailsTopContainerViewTemplate();
  }
...
export{FilmDetailsView, FilmDetailsTopContainerView, FilmDetailsBottomContainer};
